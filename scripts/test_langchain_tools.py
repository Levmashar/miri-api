#!/usr/bin/env python3
"""
LangChain test script for the OpenAI-compatible miri-api API.
...
Prerequisites:
  - miri-api API server running: python -m src.api.server
...
MODEL = "claude-browser" if _provider == "claude" else "chatgpt-browser"
API_KEY = "dummy123"  # miri-api doesn't require auth
...
def main():
    print("=" * 60)
    print("  miri-api — LangChain OpenAI-Compatible API Tests")
    print("=" * 60)
    print(f"\nBase URL: {BASE_URL}")
    print(f"Model:    {MODEL}")
