...
via the miri-api API and verifying the response format matches OpenAI's spec.
...
Prerequisites:
  ...
  - OR Docker: docker compose up --build -d chatgpt
...
def main():
    print("\n" + "=" * 70)
    print("  miri-api — Image Generation API Test Suite")
    ...
    try:
        ...
        print("  Or Docker: docker compose up --build -d chatgpt")
        sys.exit(1)
