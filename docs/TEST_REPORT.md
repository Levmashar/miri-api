...
| API: `/v1/models` | ✅ 200 | ✅ 200 | Returns `chatgpt-browser` / `claude-browser` |
...
|---|---|---|---|
| Models endpoint | ✅ PASS | — | Returns `chatgpt-browser` |
...
|---|---|---|
| ChatGPT | `chatgpt-browser` | `chatgpt` |
...
| Model ID | `chatgpt-browser` | `claude-browser` |
