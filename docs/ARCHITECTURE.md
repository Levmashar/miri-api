...
A deep dive into how miri-api works under the hood.
...
The web UIs don't have native tool-calling APIs. miri-api implements tool calling via prompt engineering.
...
|   |-- data: URL       --> base64 decode, save to /tmp/miri_files/
