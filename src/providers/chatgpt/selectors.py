...
class Selectors:
    ...
    MODEL_MENU_ITEM = ["[role='menuitemradio']", "[role='menuitem']", "[role='option']"]
    ...
    # Presence of ANY of these means we are NOT signed in. This is the decisive
    # signal: ChatGPT allows anonymous chatting, so a chat input exists even when
    # logged out — only the login/signup affordances distinguish the two.
    LOGIN_INDICATORS = [
