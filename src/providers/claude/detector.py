...
async def extract_last_response_via_copy(
    ...
    try:
        ...
        # Clipboard critical section — see src/clipboard_lock.py. The X11
        # clipboard is shared by all tabs; serialize clear→click→read so a
        # concurrent tab cannot read this tab's copied text.
