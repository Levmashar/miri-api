...
A beautiful full-screen TUI that talks to miri-api (or any OpenAI-compatible API).
...
Configuration (env vars or CLI flags):
  ...
  CATGPT_MODEL      Model name    (default: chatgpt-browser)
...
from src.core.log import suppress_console_logs
...
class ChatScreen(Screen):
    ...
    def __init__(self) -> None:
        ...
        self.model = os.getenv("CATGPT_MODEL") or "chatgpt-browser"
    ...
    async def _do_export(self, filename: str) -> None:
        ...
        name = filename or f"chatgpt-export-{ts}.md"
